...
class ColabViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        try:
            CommonUtils.Update_Create(request, ['colab_pic','colab_audio','colab_video'])
...
class DeleteColabView(APIView):
    ...
    def delete(self, request, **kwargs):
        try:
            ...
            id = kwargs.get('id')
            if field == 'song':
                # media_deletion = CommonUtils.Delete_Media(request, ['colab_pic', 'colab_audio', 'colab_video'])
                ...
                # media_deletion = CommonUtils.Delete_Media(request, ['colab_pic', 'colab_audio', 'colab_view'])
                # if media_deletion is not None:
                #     print(media_deletion)
            else:
                # media_deletion = CommonUtils.Delete_Media(request, ['colab_pic', 'colab_audio', 'colab_view'])
